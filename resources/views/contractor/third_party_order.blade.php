                                ...
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form class="form-valide" action="#" method="post">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-select2">Interviewer List<span class="text-danger"> *</span></label>
                                                <div class="col-lg-8">
                                                    <select class="js-select2 form-control" name="val-select2" style="width: 100%;" data-placeholder="Choose one..">
                                                        ...
                                                        <option value="html">Adil</option>
                                                        
                                                        <option value="javascript">Ali</option>
                                                        <option value="html">Muneeb</option>
                                                        
                                                        <option value="javascript">Hassan</option>
                                                        <option value="html">Atif</option>
                                                        
                                                        <option value="javascript">Abid</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="val-username" name="val-confirm-password" placeholder="Enter Salary Package">
                                                </div>
                                            </div>
                                            <div class="form-group row">
